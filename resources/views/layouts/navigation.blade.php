<ul>
    ...
    <li class="nav-item @if(request()->routeIs('kriteria.index')) active @endif">
        <a href="{{ route('kriteria.index') }}">
            ...
            <span class="text">{{ __('Kriteria') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('alternatif.index')) active @endif">
        <a href="{{ route('alternatif.index') }}">
            ...
            <span class="text">{{ __('Alternatif') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('penilaian.index')) active @endif">
        <a href="{{ route('penilaian.index') }}">
            ...
            <span class="text">{{ __('Penilaian') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('perhitungan.saw')) active @endif">
        <a href="{{ route('perhitungan.saw') }}">
            <span class="icon">
                <svg width="22" height="22" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
                </svg>
            </span>
            <span class="text">{{ __('perhitungan') }}</span>
        </a>
    </li>
            </li>
        </ul>
